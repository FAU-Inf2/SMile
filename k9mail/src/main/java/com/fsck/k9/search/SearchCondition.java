...
public class SearchCondition implements Parcelable {
    ...
    public final SearchSpecification.Attribute attribute;
    public final SearchSpecification.SearchField field;

    public SearchCondition(SearchSpecification.SearchField field, SearchSpecification.Attribute attribute, String value) {
        this.value = value;
    ...
    private SearchCondition(Parcel in) {
        ...
        this.attribute = SearchSpecification.Attribute.values()[in.readInt()];
        this.field = SearchSpecification.SearchField.values()[in.readInt()];
    }
